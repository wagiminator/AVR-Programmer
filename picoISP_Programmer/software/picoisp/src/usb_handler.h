...
#define USB_INIT_endpoints        ISP_EP_init     // init custom endpoints
#define USB_VENDOR_SETUP_handler  ISP_control     // handle vendor setup requests
#define USB_VENDOR_OUT_handler    ISP_EP0_OUT     // handle vendor out transfers
#define USB_VENDOR_IN_handler     ISP_EP0_IN      // handle vendor in transfers
